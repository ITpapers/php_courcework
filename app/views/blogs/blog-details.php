      ...
      <div class="row">
        <div class="col-lg-8">
          <div class="blog-details">
            ...
            <div class="thumb">
              <img src="<?=self::RES?>/images/blog/m1.jpg" alt="image">
            </div>
            <ul class="post-meta">
            ...
            <div class="content">
              ...
              <div class="row">
                <div class="col-md-4 col-6">
                  <div class="block-img">
                    <img src="<?=self::RES?>/images/blog/s1.jpg" alt="image">
                  </div>
                </div><!-- block-img end -->
                <div class="col-md-4 col-6">
                  <div class="block-img">
                    <img src="<?=self::RES?>/images/blog/s2.jpg" alt="image">
                  </div>
                </div><!-- block-img end -->
                <div class="col-md-4 col-6">
                  <div class="block-img">
                    <img src="<?=self::RES?>/images/blog/s3.jpg" alt="image">
                  </div>
                </div><!-- block-img end -->
              </div>
          ...
          <div class="post-author">
            <div class="thumb">
              <img src="<?=self::RES?>/images/blog/author.jpg" alt="image">
            </div>
            <div class="content">
            ...
            <ul class="comment-list">
              <li>
                <div class="single-comment-wrap">
                  <div class="thumb">
                    <img src="<?=self::RES?>/images/blog/rp1.jpg" alt="comment-thumb">
                  </div>
                  <div class="content">
              ...
              <li class="has-children">
                <ul>
                  <li>
                    <div class="single-comment-wrap">
                      <div class="thumb">
                        <img src="<?=self::RES?>/images/blog/rp2.jpg" alt="comment-thumb">
                      </div>
                      <div class="content">
