          ...
          <div class="col-lg-4 col-sm-8">
            <div class="footer-widget widget-about">
              <div class="widget-about-content">
                <a href="index.html" class="footer-logo"><img src="<?=self::RES?>/images/logo-footer.png" alt="logo"></a>
            ...
            <div class="footer-widget widget-address">
              ...
              <ul>
                <li>
                  ...
                  <span>4050 Stevely Ave, Los Angeles <br>CA 90008, United States</span>
                </li>
                <li>
        ...
        <div class="row justify-content-between">
          ...
          <div class="col-sm-6">
            <ul class="payment-method d-flex justify-content-end">
              <li>We accept</li>
              <li><img src="<?=self::RES?>/images/money-method/1.png" alt="image"></li>
              <li><img src="<?=self::RES?>/images/money-method/2.png" alt="image"></li>
              <li><img src="<?=self::RES?>/images/money-method/3.png" alt="image"></li>
            </ul>
          </div>
        </div>
      </div>
